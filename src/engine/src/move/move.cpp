...
Move::Move(Square source, Square target) :
    TargetSquare(target),
    SourceSquare(source),
    EnPassantTargetSquare(Square::NullSQ),
    PrevCastlingState(0),
    Piece(ChessPiece()),
...
Move::Move() :
    TargetSquare(Square::NullSQ),
    SourceSquare(Square::NullSQ),
    EnPassantTargetSquare(Square::NullSQ),
    PrevCastlingState(0),
    Piece(ChessPiece()),
    PromoteToPiece(ChessPiece()),
...
{
    u16 packedMove = 0;
    packedMove = *SourceSquare & 63;
    packedMove |= *TargetSquare & 63 << 6;
...
//         mv.TargetSquare = SquareNotation(file, rank).toSquare();
//     }
//     else {
