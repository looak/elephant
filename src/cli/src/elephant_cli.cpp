...
Application::Application()
{
	...
	MESSAGE() << " versions:\n   cli:    " << ELEPHANT_CLI_VERSION_STR << "-" << ELEPHANT_CLI_VERSION_PRERELEASE <<  ELEPHANT_CLI_VERSION_SUFFIX <<
		 "\n   engine: " << ELEPHANT_GAMBIT_VERSION_STR << "-" << ELEPHANT_GAMBIT_VERSION_PRERELEASE << ELEPHANT_GAMBIT_VERSION_SUFFIX;
